...
(function() {
  ...
  test('public methods', function() {
    ...
    return _.each(instanceMethods, function(method) {
      return ok(_this.relation[method], "relation should have the '" + method + "' instance method");
    });
  });
  ...
  test('is a backbone model', function() {
    ...
    return _.each(Backbone.Model.prototype, function(value, key) {
      ...
      ok(_this.modelClass.prototype[key], "class prototype should have the '" + key + "' property");
      return ok(_this.model[key], "instance should have the '" + key + "' property");
    });
  });
  ...
  asyncTest("methods listed in proxied are bound to the model instance", function() {
    ...
    return setTimeout((function() {
      same(_this.model.getThis(), _this.model);
      return start();
    }), 10);
  });
  ...
  test("extends Backbone.Router", function() {
    var _this = this;
    return _.each(Backbone.Router.prototype, function(value, propName) {
      ok(Fixtures.PostsController.prototype[propName], "Knockback.Controller prototype should have the '" + propName + "' property");
      return ok(_this.controller[propName], "Knockback.Controller instance should have the '" + propName + "' property");
    });
  });
  ...
  test("raises an error when the action is not recognized", function() {
    var _this = this;
    raises(function() {
      return _this.combined.filtersForAction('asdf', 'before');
    });
    return raises(function() {
      return _this.combined.filtersForAction(null, 'before');
    });
  });
